                                        ...
                                        int veh_root_part )
{
    ...
    enum {
        ...
        USE_BIKE_RACK, RELOAD_PLANTER, PLANT_HYDROPONICS, HARVEST_HYDROPONICS, KILL_HYDROPONICS
    };
    uilist selectmenu;
    ...
    switch( choice ) {
        ...
        case PLANT_HYDROPONICS:
            hydroponics::plant_hydroponics( *veh, pos, hydroponics_part );
            return DONE;

        case HARVEST_HYDROPONICS:
            hydroponics::harvest_hydroponics( *veh, pos, hydroponics_part );
            return ITEMS_FROM_GROUND;

        case KILL_HYDROPONICS:
            veh->remove_item( hydroponics_part, 0 );
            return DONE;
    }
